...
async function importQuestions() {
  try {
    ...
    if (!fs.existsSync(jsonPath)) {
      console.error(
        '❌ ملف ai_questions.json غير موجود. يرجى إنشاؤه في المجلد الرئيسي للمشروع ولصق نتيجة الذكاء الاصطناعي بداخله.'
      )
      return
    }
    ...
    if (!questions || !Array.isArray(questions)) {
      console.error(
        '❌ تنسيق الملف غير صحيح. يجب أن يحتوي على مصفوفة "questions".'
      )
      return
    }
