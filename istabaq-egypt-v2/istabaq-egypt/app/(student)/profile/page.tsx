...
export default function StudentProfilePage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(false)
    error ? toast({ title: 'خطأ', description: error.message, type: 'error' }) : toast({ title: 'تم التحديث ✅', type: 'success' })
  }
  ...
  const handleChangePwd = async () => {
    ...
    if (error) toast({ title: 'خطأ', description: error.message, type: 'error' })
    else { toast({ title: 'تم تغيير كلمة المرور ✅', type: 'success' }); setNewPassword(''); setConfirmPassword('') }
  }
