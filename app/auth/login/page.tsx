          ...
          <div className="p-8">
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white font-bold py-3.5 rounded-xl transition-all disabled:opacity-60 shadow-md"
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : 'دخول الميدان 🚀'}
              </button>
            </form>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-muted-foreground font-medium">أو</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading || googleLoading}
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 hover:border-primary/40 hover:bg-blue-50/50 text-slate-700 font-bold py-3.5 rounded-xl transition-all disabled:opacity-60 shadow-sm"
            >
              {googleLoading ? (
