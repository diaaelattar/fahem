...
export default async function SchoolDashboardPage() {
  ...
  // جلب إحصائيات المجموعات والطلاب والمعلمين
  const [
    { count: teachersCount },
    { count: classesCount },
    { count: studentsCount },
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-cyan-900/20 bg-gradient-to-b from-cyan-950/20 to-slate-950/40 p-6 space-y-4">
            <div className="flex items-center gap-2 text-cyan-400">
              ...
              <h3 className="text-sm font-bold tracking-wider uppercase">تحليلات الذكاء الاصطناعي</h3>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
              تحليل أداء المدرسة مبني على أحدث 120 محاولة اختبار للطلاب خلال الأسبوع الحالي:
            </p>
            <div className="bg-slate-950/60 rounded-xl p-4 border border-slate-900 space-y-3">
              <div className="flex gap-2">
                ...
                <p className="text-xs text-slate-200 leading-relaxed">
                  معدل استيعاب طلاب الصف الثالث الابتدائي في مادة الرياضيات ارتفع بنسبة **14%** مقارنة بالترم الماضي.
                </p>
              </div>
              <div className="flex gap-2 border-t border-slate-900 pt-3">
                <TrendingUp className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" />
                <p className="text-xs text-slate-200 leading-relaxed">
                  نوصي بتوجيه معلمي اللغة العربية للصف الرابع لإعادة مراجعة وحدة "النحو والصرف" نظراً لتراجع متوسط درجات الاختبار التجريبي.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-900 bg-slate-900/30 p-6 space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm font-bold text-white">الباقة المدرسية الشاملة (PRO)</span>
            ...
            <p className="text-xs text-slate-500">
              تاريخ التجديد القادم: 20 سبتمبر 2026
            </p>
          </div>
        </div>
      </div>
