...
export const SUBJECTS_BY_STAGE = {
  primary: ['اللغة العربية', 'اللغة الإنجليزية', 'الرياضيات', 'العلوم', 'الدراسات الاجتماعية', 'التربية الدينية الإسلامية'],
  preparatory: ['اللغة العربية', 'اللغة الإنجليزية', 'الرياضيات', 'العلوم', 'الدراسات الاجتماعية', 'التربية الدينية الإسلامية', 'الحاسوب'],
  secondary: ['اللغة العربية', 'اللغة الإنجليزية', 'الرياضيات', 'الفيزياء', 'الكيمياء', 'الأحياء', 'الجيولوجيا', 'الفلسفة والمنطق', 'علم النفس والاجتماع', 'التاريخ', 'الجغرافيا', 'الحاسوب'],
}

export function getStageByGrade(gradeNumber: number): 'primary' | 'preparatory' | 'secondary' {
