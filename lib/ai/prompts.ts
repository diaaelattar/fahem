...
3. **الصيغة الرياضية (KaTeX):** "إلزامي" كتابة أي معادلات رياضية أو أسس أو كسور داخل وسوم KaTeX: $...$ للمعادلات المدمجة و $$...$$ للكبيرة.
   - **الأسس والكسور:** يجب استخدام الصيغة الصحيحة للاسس \`a^{4}\` والكسور \`\\frac{a}{b}\`. لا تكتب أبداً \`a 4\` لتعني أس 4، بل اكتب \`a^{4}\`.
   - **العمليات:** استخدم \`\\times\` للضرب و \`\\div\` للقسمة، ونسّق الأقواس بشكل سليم \`\\left( ... \\right)\`.
