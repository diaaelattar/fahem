...
export function SchoolSettingsClient({ school }: SchoolSettingsClientProps) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn" dir="rtl">
      {/* الترويسة */}
      <div>
        <h2 className="text-xl md:text-2xl font-extrabold text-white">إعدادات المدرسة والأمان</h2>
        <p className="text-xs text-slate-400 mt-1">تحديث الهوية والمعلومات الجغرافية للمؤسسة التعليمية وإدارة أمان الحساب.</p>
      </div>

      <div className="grid grid-cols-1 gap-6 max-w-2xl mx-auto">
        {/* معلومات المدرسة العامة */}
        <div className="rounded-3xl border border-slate-900 bg-slate-950/40 backdrop-blur-xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
